...
def createDataSet1():  # 创造示例数据
    dataSet = [['奥地利', '10', '红酒'], ['荷兰', '10', '红酒'], ['荷兰', '10', '红酒'], ['奥地利', '5', '白酒'], ['荷兰', '5', '白酒'],
               ['荷兰', '10', '白酒'], ['奥地利', '10', '白酒'], ['奥地利', '10', '白酒']]
    labels = ['产地', '年份']  # 两个特征
...
def majorityCnt(typeList):  # 按分类后类别数量排序
    typeCount = {}
    for t in typeList:
    ...
    sortedTypeCount = sorted(typeCount.items(), key=lambda x: x[1], reverse=True)  # 从大到小排列
    print('多数为 :', sortedTypeCount[0][0])
